      ...
      >
        ...
        <div className="z-10 w-full max-w-md bg-opacity-100 rounded-xl p-4 text-white mt-0">
            ...
            <div className="border border-dashed border-gray-400 p-4 rounded-lg text-center">
              ...
              {imageSelected && (
                <div className="mt-3 flex gap-3 justify-center">
                  <button className="bg-blue-600 text-white px-3 py-1 rounded text-sm" type="button">
                    Change
                  </button>
                  <button className="bg-red-600 text-white px-3 py-1 rounded text-sm" type="button" onClick={handleDelete}>
                    Delete
                  </button>
                </div>
              )}
          ...
          <div className="text-center mt-6">
            <button className="bg-orange-700 hover:bg-orange-600 text-white px-5 py-3 rounded-lg text-base w-full">
              Generate My Ticket
            </button>
          </div>
        </div>
